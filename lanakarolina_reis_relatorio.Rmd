...
author: "Lana Karolina da S. Reis"
output: "pdf_document"
theme: "paper"
---
```{r setup, include=FALSE}
setwd("C:/Users/Lavo/Desktop/Pós - Ciencia de Dados/03 Análise Estatística de Dados/Projeto Final/Meu Projeto") 
library(tidyverse)
library(plotly)
library(e1071)
library(Hmisc)
...
```{r}
describe(bd$NT_OBJ_FG) # nota bruta da formação geral (quantitativo continuo)
describe(bd$CO_GRUPO) # codigo do curso (quantitativo discreto)
describe(bd$CO_REGIAO_CURSO) # codigo da regiao do curso (quantitativo discreto)
describe(bd$QE_I02) # etnia do estudante (qualitativo nominal)
describe(bd$CO_TURNO_GRADUACAO) # codigo do turno do curso (quantitativo discreto)
```
